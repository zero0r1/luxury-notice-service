...
//        Authenticator.setDefault(new MyAuthenticator(MimvpProxyJava.PROXY_USERNAME, MimvpProxyJava.PROXY_PASSWORD));
    ...
    public static int proxy_protocol(String proxyType, String proxyIpPort) {
        int dataLen = 0;
...
//			Authenticator.setDefault(new MyAuthenticator(MimvpProxyJava.PROXY_USERNAME, MimvpProxyJava.PROXY_PASSWORD));
    ...
    // 使用函数协议，仅支持 HTTP 和 SOCKS5
    public static String proxy_protocol(String proxyType, String proxyIpPort, String proxyUrl) {
        int dataLen = 0;
